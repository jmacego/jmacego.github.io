...
*Part of a series on what the dot-com era can teach us about AI. [← First: Bubbles Can Build Foundations](/blog/ai-vs-dot-com-bubbles-can-build-foundations/) · [← Previous: Smartphones Made the Internet Ambient](/blog/smartphones-made-the-internet-ambient/)*

I am writing this installment from Southeast Asia, which lived through a version of the same compressed sequence on a different timeline and with different outcomes. The series so far has argued that bubbles can finance durable infrastructure, that e-commerce rewired retail through a long alignment of search, payments, logistics, and habit, that streaming replaced physical media only once a checklist of preconditions closed quietly, and that the smartphone's real achievement was turning the internet from a place into an ambient layer. This post pushes on who got access on what timeline, and asks whether AI is likely to reach the people most commentators are not currently writing about.
...
The connectivity we had in Tanzania in that period was satellite. Not an exotic satellite — the same physical infrastructure that served European markets. IP-over-MPEG2 was the dominant rig. A 256 kbps link in Europe cost one thing; the same link in country cost two to three times as much, because the regulation required the service be delivered through approved domestic contractors. The satellite companies could not sell to you directly. They had to sell through a local license holder, and the local license holder set the price.
...
Who were the gatekeepers? Regulators and politically connected resellers, in that order, with the second group generally a proxy for the first. The pattern was not unique to Tanzania and is not ancient history. It was how you built a communications business in most of the region during that period, and variants of it persist now in sectors where regulatory permission is the scarce input and technical capability is abundant.

The AI parallel here is sharper than most commentators notice. Regulated AI — in healthcare, legal advice, financial services, education — is going to route through exactly this kind of licensed-intermediary structure in most jurisdictions. The model weights are the satellite. The certified local operator is the domestic contractor. The rent extraction will look similar, because the underlying scarcity is political permission rather than technical capacity. This is not a complaint. It is a prediction. In markets where AI is most needed but most regulated, expect the same multiplier to appear between what the technology could deliver and what end users actually pay for a weaker version of it.
...
Device cost is the first and largest. GSMA's handset-affordability work estimates that a $30 smartphone would bring up to 1.6 billion more people into the affordability range. We are not close to that price point for a device capable of useful on-device AI, and cloud-dependent AI pushes the data-cost question harder at exactly the income levels where data cost is already the binding constraint.
...
Regulation can enable or strangle, and the history is not encouraging. In healthcare and legal services, the licensing regimes that exist to protect consumers also exist to protect incumbents, and the difference between those two functions is often visible only in retrospect. Markets with weak professional capacity and strong protective licensing are markets where AI expansion is most needed and most legally complicated. The satellite-contractor dynamic I described earlier is the cleanest prior.
...
The period I was in Tanzania overlapped the early Afghanistan and second Gulf conflicts, and the other kind of foreigner coming through was military and the contractor ecosystem that followed the military. I spent a lot of time in airports and on planes with those people, and a lot of the serious remote-communications and internet technology I was ever allowed to touch came from that world first, and from consumer markets second.

This is not a surprising arrangement to anyone who has looked at the history of the internet itself. The substrate was defence-funded, the early networks were operated for defence purposes, and the techniques that hardened into the commercial internet had been developed, stress-tested, and normalised in military and intelligence contexts first. What changed after the dot-com bubble is that the pipeline became bidirectional. Consumer scale produced hardware and software that the military then adopted, and military investment continued to shape the specification of what got built at the frontier.

The AI pipeline is working out the same way right now. The major labs — Anthropic among them, along with its peers — are visibly serving US defence and intelligence customers. The same capabilities showing up in enterprise and consumer products are being tuned, evaluated, and hardened under contract for classified use. This is not a moral argument. It is an observational one. If you want to predict where AI capability will be pressed hardest, it is worth watching where the defence contracts are going, because historically that is where the real-world stress testing has happened, and that is where the tooling that eventually shows up in commercial settings has been matured.
...
The harder and more honest question is whether AI compounds existing inequalities while the distribution unfolds. It could. The people currently writing about AI are the people most visible to AI product managers, the people whose workflows get optimised first, and the people whose productivity gains get measured and publicised. Meanwhile, the populations who would benefit most from expert access at the margin remain outside the feedback loop that shapes what gets built. Mobile narrowed some gaps and widened others. AI will do the same, and the mix will depend on choices — pricing, language, regulation, device cost, infrastructure — that are not inevitable and are currently being made.
