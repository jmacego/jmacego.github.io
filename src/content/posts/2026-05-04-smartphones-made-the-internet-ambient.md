...
Newspapers collapsed. Retail geography compressed. Local advertising markets that had supported a broad class of small independent businesses were hollowed out by two or three platforms whose scale and targeting precision outcompeted the local alternative almost completely. Political discourse restructured around formats that reward intensity over duration. Adolescent mental health indicators, according to a widening body of research, worsened materially after 2012 in ways that track smartphone and social media adoption closely enough that the null hypothesis is hard to sustain.
